...
(function () {
  ...
  const STEPS = {
    tab1: [
      ...
      { sel: '.food-scan-btn',           text: 'להוספת מנה: צילום אוכל וזיהוי אוטומטי ב-AI <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px"><path d="M4 8h3l1.5-2h7L17 8h3a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1z"/><circle cx="12" cy="13.5" r="3.5"/></svg>, העלאת תמונה <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px"><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="M21 16l-5.5-5.5L9 17"/></svg>, או הזנה בכתב <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-2px"><path d="M4 20l1-4L16.5 4.5a2.1 2.1 0 0 1 3 3L8 19l-4 1z"/><path d="M4 20h16"/></svg>. כדאי לנסות לבד' },
    ...
    general: [
      ...
      { sel: '.hamburger-btn', pre: closeMenu, text: function () {
          return isSubscriber()
            ? 'התפריט העליון. כאן נמצאים הפרופיל, מאמן ה-AI, וואטסאפ למאמן'
