...
(function () {
  ...
  const STEPS = {
    ...
    ai: [
      ...
      { sel: 'button[onclick="resetAIChat()"]', text: 'איפוס השיחה ופתיחת שיחה חדשה' },
      { sel: '#ai-quick-chips', text: 'שאלות מוצעות בהתאמה אישית, לפי הנתונים והתקדמות שלך. לחיצה על שאלה שולחת אותה ישר לסוכן' },
      ...
      { sel: '#tab5 .ai-disclaimer', text: 'הסוכן עשוי לטעות, יש להשתמש בו ככלי עזר בלבד' },
    ],
    general: [
