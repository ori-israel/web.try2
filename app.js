...
async function handleBarcodeFile(file) {
    ...
    // 1. BarcodeDetector (native — most reliable)
    ...
    if (code) {
        ...
        errEl.textContent = '⚠️ לא זוהה ברקוד — נסה לצלם ישר ובאור טוב';
